...
#pragma config(Motor,  port1,           rightWheel1,   tmotorVex393_HBridge, openLoop, reversed, encoderPort, I2C_2)
#pragma config(Motor,  port2,           leftLift1,     tmotorVex393_MC29, openLoop, encoderPort, I2C_3)
...
#pragma config(Motor,  port10,          leftWheel1,    tmotorVex393_HBridge, openLoop, encoderPort, I2C_1)
	...
	while(true) {
		if(!debugMode) {
			...
			if(vexRT[Btn5U]) {
				...
				lift(SensorValue[liftEnc]>-800?15:0);
			}
		}
